...
TheoryCraft_Locale = {
	...
	Set		= "%(%d+/%d+%)",
	LoadText	= "TheoryCraft вер. "..TheoryCraft_Version.." от Aelian. Введите /tc для настроек. Введите /tc more для скрытых функций.",
	lifetap		= "Жизнеотвод",
	MinMax  = {
...
-- Shaman
		...
		{ id="tidalfocus", translated="Средоточие приливов" },
...
-- Druid
		{ id="impwrath", translated="Гнев" },
		{ id="impmoon", translated="Лунный огонь" },
		{ id="vengeance", translated="Отмщение" },
		{ id="impstarfire", translated="Звездный огонь" },
		...
		{ id="imprejuve", translated="Омоложение" },
		{ id="giftofnat", translated="Gift of Nat" },
		{ id="impregrowth", translated="Восстановление" },
-- Paladin
